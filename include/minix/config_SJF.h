...
#define SHORTESTJF_Q			8	/* process priority(level) reserved for SJF scheduling */
#define SHORTESTJF_QUANTUM 		650000000	/* quanta for SJF-scheduled processes is set too high to avoid preemption*/
#define SHORTESTJF_MIN_EXP_TIME 	0
#define SHORTESTJF_RESET_POLICY 	0
#define SHORTESTJF_MAX_EXP_TIME 	100
